...
async function setupViewer(){
    ...
    await manager.addFromPath("./assets/wasp.glb")
    ...
    viewer.scene.activeCamera.setCameraOptions({controlsEnabled: true,fov:25})
    ...
    document.querySelectorAll('.button--navbar')?.forEach(item => {
		item.addEventListener('click', () => {
